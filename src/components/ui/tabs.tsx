...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-background/5 p-1 text-muted-foreground border border-white/10",
      className
    )}
    {...props}
  />
