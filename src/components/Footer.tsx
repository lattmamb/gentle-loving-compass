      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="col-span-2">
            <Link to="/" className="text-white font-bold text-2xl mb-4 inline-block">
              <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                EonRides
              </span>
            </Link>
            <p className="text-white/70 mb-4 max-w-md">
              Premium Tesla vehicle subscriptions with flexible plans and no long-term commitments. Experience the future of mobility.
            </p>
          ...
          <div>
            <h3 className="font-medium text-lg mb-3 text-white">Resources</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-medium text-lg mb-3 text-white">Legal</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} EonRides, Inc. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <Link to="/contact" className="text-white/60 hover:text-white text-sm">
              Contact
            </Link>
          </div>
        </div>
